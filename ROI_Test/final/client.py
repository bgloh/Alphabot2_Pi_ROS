...
power_right = 28
def forward():
    setMotor(CH1, power_left, FORWARD)
    setMotor(CH2, power_right, FORWARD)
def backward():
    setMotor(CH1, power_left, BACKWORD)
    setMotor(CH2, power_right, BACKWORD)
def left():
    setMotor(CH1, power_left -4, BACKWORD)
    setMotor(CH2, power_right -4, FORWARD)
def right():
    setMotor(CH1, power_left -4, FORWARD)
    setMotor(CH2, power_right -4, BACKWORD)
def stop():
    setMotor(CH1, 0, STOP)
    setMotor(CH2, 0, STOP)
