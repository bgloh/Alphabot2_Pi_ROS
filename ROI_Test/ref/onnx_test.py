...
env_path = "C:/Users/User/Desktop/Unity/MLAgent_v2/DuckieBotProject.exe"
#model = "Test.onnx"
model = "C:/Users/User/Desktop/Unity/MLAgent_v3/Assets/Duckie.onnx"
...
for episode in range(3):
  ...
  while not done:
    ...
    output = sess.run(["discrete_actions"], {"obs_0": np.array(decision_steps.obs[0]).transpose(order),
