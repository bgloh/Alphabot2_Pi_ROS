...
img = cv2.imread('./asset/edge_pt2_img.png')
img_copy = img.copy()
...
if len(target_45)>=1:
    ...
    cv2.circle(crop, (target_45[target_center_num45][0], target_45[target_center_num45][1]), 10, (0, 255, 0), -1)
    cv2.line(crop, (x, y), (target_45[target_center_num45][0], target_45[target_center_num45][1]), (0, 255, 0), 5)
...
if len(target_90)>=1:
    ...
    cv2.circle(crop, (target_90[target_center_num90][0], target_90[target_center_num90][1]), 10, (0, 255, 0), -1)
    cv2.line(crop, (x, y), (target_90[target_center_num90][0], target_90[target_center_num90][1]), (0, 255, 0), 5)
...
if len(target_135)>=1:
    ...
    cv2.circle(crop, (target_135[target_center_num135][0], target_135[target_center_num135][1]), 10, (0, 255, 0), -1)
    cv2.line(crop, (x, y), (target_135[target_center_num135][0], target_135[target_center_num135][1]), (0, 255, 0), 5)
...
if len(target_180)>=1:
    ...
    cv2.circle(crop, (target_180[target_center_num180][0], target_180[target_center_num180][1]), 10, (0, 255, 0), -1)
    cv2.line(crop, (x, y), (target_180[target_center_num180][0], target_180[target_center_num180][1]), (0, 255, 0), 5)
