...
print(dis)
print(min_dis_index)
print(target_90[min_dis_index])
cv2.line(crop, (x, y), (target_90[min_dis_index][0], target_90[min_dis_index][1]), (0, 255, 0), 5)
'''
if len(target_0)>=1:
...
# target_90 원소 확인
'''for num in range(0,len(target_90)):
    print(target_90[num])
    print(target_90[num][0][0])
    print(target_90[num][0][1])
    print(target_90[num][1])'''
