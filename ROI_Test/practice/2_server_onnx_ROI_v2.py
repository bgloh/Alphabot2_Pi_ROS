...
while True:
    ...
    '''ROI 설정
    crop
        1) (높이의 중간부터 시작하여 바닥까지, 너비, 채널) size를 가진 크기로 자르기
        2) onnx 파일의 input과 사이즈를 맞추기 위해 본래 사이즈로 resize 
    '''
    ...
    cv2.imshow('Frame', frame)
    # cv2.imshow('crop',crop_resize) # ROI 설정된 카메라를 보고 싶을 때 사용
    '''
    MQTT SERVER
    '''
